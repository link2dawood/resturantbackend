        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">Managers</h2>
                </div>
                                ...
                                <table class="table table-vcenter card-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-list">
                                                    <a href="{{ route('managers.edit', $manager->id) }}" class="btn btn-sm btn-outline-primary">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a href="{{ route('managers.assign-stores', $manager->id) }}" class="dropdown-item">
