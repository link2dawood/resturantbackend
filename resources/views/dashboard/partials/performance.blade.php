...
<style>
    ...
    .perf-bar__period select { border: 1px solid #dde3ec; border-radius: 999px; padding: .4rem .9rem; font-size: .9rem;
        font-weight: 600; color: #1d2b3a; background: #f7f9fc; cursor: pointer; }
    .perf-bar__period select:focus { outline: none; border-color: #206bc4; box-shadow: 0 0 0 3px rgba(32,107,196,.14); }
</style>
...
<div class="perf-bar">
    ...
    <div class="perf-bar__right">
        ...
        <form method="GET" action="{{ url()->current() }}" class="perf-bar__period">
