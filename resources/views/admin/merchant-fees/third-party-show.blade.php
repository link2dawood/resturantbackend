    ...
    <div class="mb-4">
        ...
        <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
            ...
            <div class="d-flex align-items-center gap-2">
                <form action="{{ route('admin.merchant-fees.third-party.destroy', $statement) }}" method="POST" class="d-inline" onsubmit="return confirm('Delete this statement and all related expense transactions and expected deposit? This cannot be undone.');">
                    @csrf
                    @method('DELETE')
