                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="personal_phone" class="form-control @error('personal_phone') is-invalid @enderror" 
                                           value="{{ old('personal_phone') }}" placeholder="Personal phone number">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <textarea name="corporate_address" class="form-control @error('corporate_address') is-invalid @enderror" 
                                      rows="3" placeholder="Full corporate address">{{ old('corporate_address') }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="corporate_phone" class="form-control @error('corporate_phone') is-invalid @enderror" 
                                           value="{{ old('corporate_phone') }}" placeholder="Corporate phone number">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="corporate_ein" class="form-control @error('corporate_ein') is-invalid @enderror" 
                                           value="{{ old('corporate_ein') }}" placeholder="XX-XXXXXXX">
                                    @error('corporate_ein')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
