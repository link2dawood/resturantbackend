...
class DailyReportRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'amount_of_cancels' => ['nullable', 'numeric', 'min:0', 'max:999999.99'],
            'amount_of_voids' => ['nullable', 'numeric', 'min:0', 'max:999999.99'],
            'number_of_no_sales' => ['nullable', 'integer', 'min:0', 'max:99999'],
