...
class FannsPhillyOrderGuideSeeder extends Seeder
{
    ...
    private const ITEMS = [
        ...
        ['name' => 'Diet Coke (Bag-in-Box)', 'category' => 'Beverages', 'base_unit' => 'each', 'purchase_unit' => 'case', 'units_per_purchase' => 1, 'vendors' => ['Coca-Cola']],
        ['name' => 'Diet Coke (20oz Bottle)', 'category' => 'Beverages', 'base_unit' => 'each', 'purchase_unit' => 'case', 'units_per_purchase' => 1, 'vendors' => ['Coca-Cola']],
        ...
        ['name' => 'Dr. Pepper (Bag-in-Box)', 'category' => 'Beverages', 'base_unit' => 'each', 'purchase_unit' => 'case', 'units_per_purchase' => 1, 'vendors' => ['Coca-Cola']],
        ['name' => 'Dr. Pepper (20oz Bottle)', 'category' => 'Beverages', 'base_unit' => 'each', 'purchase_unit' => 'case', 'units_per_purchase' => 1, 'vendors' => ['Coca-Cola']],
        ['name' => 'Diet Dr. Pepper (Bag-in-Box)', 'category' => 'Beverages', 'base_unit' => 'each', 'purchase_unit' => 'case', 'units_per_purchase' => 1, 'vendors' => ['Coca-Cola']],
        ['name' => 'Diet Dr. Pepper (20oz Bottle)', 'category' => 'Beverages', 'base_unit' => 'each', 'purchase_unit' => 'case', 'units_per_purchase' => 1, 'vendors' => ['Coca-Cola']],
        ...
        ['name' => 'Coke Zero (Bag-in-Box)', 'category' => 'Beverages', 'base_unit' => 'each', 'purchase_unit' => 'case', 'units_per_purchase' => 1, 'vendors' => ['Coca-Cola']],
        ['name' => 'Coke Zero (20oz Bottle)', 'category' => 'Beverages', 'base_unit' => 'each', 'purchase_unit' => 'case', 'units_per_purchase' => 1, 'vendors' => ['Coca-Cola']],
        ...
        ['name' => 'Sprite (Bag-in-Box)', 'category' => 'Beverages', 'base_unit' => 'each', 'purchase_unit' => 'case', 'units_per_purchase' => 1, 'vendors' => ['Coca-Cola']],
        ['name' => 'Sprite (20oz Bottle)', 'category' => 'Beverages', 'base_unit' => 'each', 'purchase_unit' => 'case', 'units_per_purchase' => 1, 'vendors' => ['Coca-Cola']],
